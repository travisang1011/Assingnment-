        ...
        <div class="row">
            <div class="col-md-12 col-lg-8">
                <div class="title-single-box">
                    <h1 class="title-single">Your Transaction History
        ...
        <div class="row" style="min-height: 350px;">
            ...
            <div class="table">
                <table class="table table-striped">
                    ...
                    <tbody>
                    <?php $no = 0;
                    foreach ($use->getTransactionHistory($_SESSION['member']['id']) as $item):
                        ?>
                        <tr>
                            <td><?= $no += 1; ?></td>
                            <td><?= $item['name'] ?></td>
                            ...
                            <td>
                                <a href="detail-history.php?id=<?=$item['id_trans'] ?>" title="Detail history" class="btn btn-info"><i class="fa fa-eye"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
