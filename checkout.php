...
if (isset($_POST['submit'])) {
    $use->checkoutOrder($_POST['name'], $_POST['phone'], $_POST['address'], $_POST['pickup']);
    header("location: confirmation.php");
}
if (empty($_SESSION['member'])) {
    echo "<script>alert('You need to login for checkout');location='login.php'</script>";
}
if (empty($_SESSION['keranjang'])) {
    echo "<script>alert('Your booking bag is empty');location='index.php'</script>";
}
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    <title>Checkout | AssignmentBus</title>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-8">
                <div class="title-single-box">
                    <h1 class="title-single">Finisih your booking order
            ...
            <div class="col-md-6">
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="pickup" id="" class="form-control" rows="4"></textarea>
                    </div>
